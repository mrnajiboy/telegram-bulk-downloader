...
## Topic Filtering 
I noticed that this didn't have any ability to filter via Topics Channels (which are technically just reply threads for the main channel), so I added the function and verbiage in the cli navigation. If a channel ID is detected as a forum it will automatically ask you if you'd like to filter for Topics.
